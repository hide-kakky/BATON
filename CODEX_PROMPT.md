...
## 1. プロジェクト概要
- **プロダクト**：`TASUKI`（参照：`docs/TASUKI_requirements_v8.5.md`）
...
## 5. 参照資料
- **要件定義書**：`docs/TASUKI_requirements_v8.5.md`
- **実装手引書**：`docs/TASUKI_implementation_guide_v1.0.md`
...
- **参照徹底**：`docs/TASUKI_requirements_v8.5.md` / `.yaml` と `docs/TASUKI_implementation_guide_v1.0.md` / `.yaml` を毎回読み、要件を引用した上で作業方針を決めること。
